...
const nacionalidad = (users, nat) => {
    let result = users.filter( (user) => user.nat === nat )
    return result
}

console.log(nacionalidad(users,"UA"))
